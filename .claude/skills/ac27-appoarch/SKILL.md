...
A BepInEx 6 IL2CPP plugin (`com.ac27.appoarch` v1.0.1) that live-patches aircraft in Airport Control 25 (Playtest) **while the game runs**. No overlay, no hotkeys — driven entirely through the game's own UDP command service (`127.0.0.1:20267`). Three commands:
