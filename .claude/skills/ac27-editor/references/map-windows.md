...
**Tests:** 340 Vitest tests across 6 files: `voiceNumberParser.test.js` (27), `voiceCallsignParser.test.js` (40), `voiceCommandMatcher.test.js` (21, legacy), `voiceSpokenNumberValue.test.js` (32), `voiceTranscriptParser.test.js` (53), `voiceDeviationMatrix.test.js` (167 — data-driven rows from the deviation matrix).
