...
itRow([
  ...
  { name: 'filler mid-phrase: "turn left uh heading 360" → full pattern match (connector-skip), no notice', input: 'CSC6918: turn left uh heading 360', callsign: 'CSC6918', commandTypes: ['update_heading'], commandLabels: ['Fly Heading 360'], noNotices: true },
], 'deviation matrix — range & unsupported');

// ─── 8b. Fuzzy acceptance (Windows System.Speech dictation artifacts) ──
// Every row pins one accepted D-L/curated confusion. The EXHAUSTIVE table
// (every dictionary word within the D-L cap of every grammar token) lives in
// tests/components/MapWindows/voiceFuzzyAcceptance.json, generated by
// scripts/gen_voice_fuzzy_acceptance.mjs and round-trip-verified against the
// runtime lookups; these rows pin the end-to-end behavior of the interesting
// (and hazardous) ones. The two semantic inversions (ascend→descend,
// decrease→increase) are EXCLUDED and can never parse.

itRow([
  // airline name words (F7 — D-L ≤ 1, ≤ 1 fuzzy word per name)
  { name: 'fuzzy airline word ("hainann one two three four" → CHH1234)', input: 'hainann one two three four', callsign: 'CHH1234' },
  { name: 'fuzzy airline word ("untied one one one one" → UAL1111)', input: 'untied one one one one', callsign: 'UAL1111' },
  { name: 'fuzzy airline word ("della three four oh one" → DAL3401)', input: 'della three four oh one', callsign: 'DAL3401' },
  { name: 'fuzzy airline word ("string airlines one two three" → CQH123)', input: 'string airlines one two three', aircraft: [ac('CQH123')], callsign: 'CQH123' },
  { name: 'fuzzy airline word ("okey one two three" → CJX123)', input: 'okey one two three', aircraft: [ac('CJX123')], callsign: 'CJX123' },
  // flight numbers (F5 — D-L ≤ 1, command words guarded out)
  { name: 'fuzzy digit word ("united one one one too" → UAL1112)', input: 'united one one one too', aircraft: [ac('UAL1112')], callsign: 'UAL1112' },
  // heading (F3 pattern words + F5 value digits)
  { name: 'fuzzy pattern word ("turn lef heading 360")', input: 'CSC6918: turn lef heading 360', callsign: 'CSC6918', commandTypes: ['update_heading'], commandLabels: ['Fly Heading 360'] },
  { name: 'fuzzy pattern word ≥6 ("fly heeding 120")', input: 'CSC6918: fly heeding 120', callsign: 'CSC6918', commandTypes: ['update_heading'], commandLabels: ['Fly Heading 120'] },
  { name: 'accepted fuzzy boundary ("fly reading 120" → heading)', input: 'CSC6918: fly reading 120', callsign: 'CSC6918', commandTypes: ['update_heading'], commandLabels: ['Fly Heading 120'] },
  { name: '"turn lift heading 360" → left (lift is a real SAPI artifact)', input: 'CSC6918: turn lift heading 360', callsign: 'CSC6918', commandTypes: ['update_heading'], commandLabels: ['Fly Heading 360'] },
  { name: '"turn light heading 360" → right (deliberate)', input: 'CSC6918: turn light heading 360', callsign: 'CSC6918', commandTypes: ['update_heading'], commandLabels: ['Fly Heading 360'] },
  { name: '"turn eight heading 360" → right (deliberate — nobody says "turn eight heading")', input: 'CSC6918: turn eight heading 360', callsign: 'CSC6918', commandTypes: ['update_heading'], commandLabels: ['Fly Heading 360'] },
  { name: '"turn two heading 360" → to (the "to" carve-out)', input: 'CSC6918: turn two heading 360', callsign: 'CSC6918', commandTypes: ['update_heading'], commandLabels: ['Fly Heading 360'] },
  { name: 'fuzzy value digit ("fly heading to zero zero" → 200, to→two)', input: 'CSC6918: fly heading to zero zero', callsign: 'CSC6918', commandTypes: ['update_heading'], commandLabels: ['Fly Heading 200'] },
  { name: 'fuzzy value digit ("fly heading one for five" → 145, for→four mid-value)', input: 'CSC6918: fly heading one for five', callsign: 'CSC6918', commandTypes: ['update_heading'], commandLabels: ['Fly Heading 145'] },
  { name: 'fuzzy value digit ("fly heading tree zero zero" → 300)', input: 'CSC6918: fly heading tree zero zero', callsign: 'CSC6918', commandTypes: ['update_heading'], commandLabels: ['Fly Heading 300'] },
  { name: 'fuzzy value digit ("fly heading sex zero" → 60, classic SAPI artifact)', input: 'CSC6918: fly heading sex zero', callsign: 'CSC6918', commandTypes: ['update_heading'], commandLabels: ['Fly Heading 060'] },
  { name: 'fuzzy value digit ("fly heading even zero" → 70)', input: 'CSC6918: fly heading even zero', callsign: 'CSC6918', commandTypes: ['update_heading'], commandLabels: ['Fly Heading 070'] },
  { name: 'fuzzy value digit ("fly heading height zero" → 80)', input: 'CSC6918: fly heading height zero', callsign: 'CSC6918', commandTypes: ['update_heading'], commandLabels: ['Fly Heading 080'] },
  { name: 'aviation addition ("fly heading one two niner" → 129)', input: 'CSC6918: fly heading one two niner', callsign: 'CSC6918', commandTypes: ['update_heading'], commandLabels: ['Fly Heading 129'] },
  // altitude (F3 connector-skip / fuzzy words, F5 magnitude, F6 units, curated FL)
  { name: 'one stray connector skipped ("climb and then maintain 9000")', input: 'CSC6918: climb and then maintain 9000', callsign: 'CSC6918', commandTypes: ['altitude'], commandLabels: ['Fly Altitude 9000'], noNotices: true },
  { name: 'fuzzy word inside multiword ("climb an maintain 9000", an→and)', input: 'CSC6918: climb an maintain 9000', callsign: 'CSC6918', commandTypes: ['altitude'], commandLabels: ['Fly Altitude 9000'] },
  { name: 'fuzzy single-word pattern ("maintains 9000")', input: 'CSC6918: maintains 9000', callsign: 'CSC6918', commandTypes: ['altitude'], commandLabels: ['Fly Altitude 9000'] },
  { name: 'fuzzy d2 win ("climb and mountain 9000", mountain→maintain)', input: 'CSC6918: climb and mountain 9000', callsign: 'CSC6918', commandTypes: ['altitude'], commandLabels: ['Fly Altitude 9000'] },
  { name: 'fuzzy d2 win ("decent and maintain 9000", decent→descend)', input: 'CSC6918: decent and maintain 9000', callsign: 'CSC6918', commandTypes: ['altitude'], commandLabels: ['Fly Altitude 9000'] },
  { name: '"level of 9000" → off (of→off)', input: 'CSC6918: level of 9000', callsign: 'CSC6918', commandTypes: ['altitude'], commandLabels: ['Fly Altitude 9000'] },
  { name: 'fuzzy magnitude word ("climb to nine thousan")', input: 'CSC6918: climb to nine thousan', callsign: 'CSC6918', commandTypes: ['altitude'], commandLabels: ['Fly Altitude 9000'] },
  { name: 'fuzzy unit word ("descend to five thousand feat")', input: 'CSC6918: descend to five thousand feat', callsign: 'CSC6918', commandTypes: ['altitude'], commandLabels: ['Fly Altitude 5000'] },
  { name: 'fuzzy unit word ("descend to five thousand feets")', input: 'CSC6918: descend to five thousand feets', callsign: 'CSC6918', commandTypes: ['altitude'], commandLabels: ['Fly Altitude 5000'] },
  { name: 'spelled FL ("eff el 90" → FL 90)', input: 'CSC6918: eff el 90', callsign: 'CSC6918', commandTypes: ['altitude'], commandLabels: ['Fly Altitude 9000'], noNotices: true },
  // speed (F5/F6)
  { name: 'fuzzy "and" inside magnitude ("reduce speed to one hundred an fifty knots" → 150)', input: 'CSC6918: reduce speed to one hundred an fifty knots', callsign: 'CSC6918', commandTypes: ['update_speed'], commandLabels: ['Fly Speed 150'] },
  { name: 'fuzzy "and" via "any" ("reduce speed to one hundred any fifty knots" → 150)', input: 'CSC6918: reduce speed to one hundred any fifty knots', callsign: 'CSC6918', commandTypes: ['update_speed'], commandLabels: ['Fly Speed 150'] },
  { name: 'fuzzy unit word ("reduce speed to one eighty knotts")', input: 'CSC6918: reduce speed to one eighty knotts', callsign: 'CSC6918', commandTypes: ['update_speed'], commandLabels: ['Fly Speed 180'] },
  { name: 'fuzzy unit word ("reduce speed to one eighty nots", SAPI drops the k)', input: 'CSC6918: reduce speed to one eighty nots', callsign: 'CSC6918', commandTypes: ['update_speed'], commandLabels: ['Fly Speed 180'] },
  // clear for approach (F4 curated windows + fuzzy types)
  { name: 'curated type ("clear for the r nav approach")', input: 'CSC6918: clear for the r nav approach', callsign: 'CSC6918', commandTypes: ['clear_for_appr'], commandLabels: ['Clear for Approach'] },
  { name: 'curated type ("cleared for the eye el ess approach")', input: 'CSC6918: cleared for the eye el ess approach', callsign: 'CSC6918', commandTypes: ['clear_for_appr'], commandLabels: ['Clear for Approach'] },
  { name: 'curated type ("clear for the vee or approach")', input: 'CSC6918: clear for the vee or approach', callsign: 'CSC6918', commandTypes: ['clear_for_appr'], commandLabels: ['Clear for Approach'] },
  { name: 'fuzzy type ("clear for the rnavv approach")', input: 'CSC6918: clear for the rnavv approach', callsign: 'CSC6918', commandTypes: ['clear_for_appr'], commandLabels: ['Clear for Approach'] },
  { name: 'fuzzy type ("clear for the nav approach", nav→rnav)', input: 'CSC6918: clear for the nav approach', callsign: 'CSC6918', commandTypes: ['clear_for_appr'], commandLabels: ['Clear for Approach'] },
  { name: 'fuzzy type ("clear for the lock approach", lock→loc)', input: 'CSC6918: clear for the lock approach', callsign: 'CSC6918', commandTypes: ['clear_for_appr'], commandLabels: ['Clear for Approach'] },
  // excluded semantic inversions — the climb/deceleration words stay noticed
  { name: '"ascend and maintain 9000" → ascend EXCLUDED (never descends); maintain still applies', input: 'CSC6918: ascend and maintain 9000', callsign: 'CSC6918', commandTypes: ['altitude'], commandLabels: ['Fly Altitude 9000'], noticeIncl: 'unsupported' },
  { name: '"decrease speed to 180" → decrease EXCLUDED (never increases) — no speed command, noticed (limitation)', input: 'CSC6918: decrease speed to 180', callsign: 'CSC6918', noticeIncl: 'unsupported' },
