...
```bash
npm run test:all      # Full suite: Vitest (1958) + save integrity (27) + jetway rebuild (27) + runway pairs (5) + E2E (18, ~8 min)
npm test              # Vitest component + store + utility + electron + integration + MapWindow + updater tests (1958 tests, 105 files, ~28s)
...
## Layer 1 — Vitest Component Tests (1958 tests, 105 files)
...
### `npm test` — 1958 pass (105 test files; includes the Ground Painter scenery suite + airway roundtrip + the full Livery page suite)
...
| **Livery page (custom liveries):** | **404** | |
