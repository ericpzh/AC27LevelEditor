...
## Layer 1 - Vitest Component Tests (2350 tests, 130 files)
...
### `npm test` - 2350 pass + 7 skipped (130 test files; includes the Ground Painter scenery suite + airway roundtrip + the full Livery page suite + the aviationstack realtime-import suite + the Workshop publish suite)
