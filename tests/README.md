...
```bash
npm run test:all      # Full suite: Vitest (1984) + save integrity (27) + jetway rebuild (27) + runway pairs (5) + E2E (18, ~8 min)
npm test              # Vitest component + store + utility + electron + integration + MapWindow + updater tests (1984 tests, 105 files, ~32s)
...
## Layer 1 — Vitest Component Tests (1984 tests, 105 files)
...
### `npm test` — 1984 pass (105 test files; includes the Ground Painter scenery suite + airway roundtrip + the full Livery page suite)
...
| **Livery page (custom liveries):** | **430** | |
