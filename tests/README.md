...
npm test              # Vitest component + store + utility + electron + integration + MapWindow + updater tests (2216 tests, 117 files, ~30s)
...
## Layer 1 — Vitest Component Tests (2181 tests, 116 files)
...
### `npm test` — 2170 pass (115 test files; includes the Ground Painter scenery suite + airway roundtrip + the full Livery page suite + the aviationstack realtime-import suite + the Workshop publish suite)
