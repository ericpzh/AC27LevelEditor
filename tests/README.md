...
| `components/BrowserScreen/BrowserHelpOverlay.test.jsx` | 11 | Help overlay renders title + section headings (Header Buttons/Settings Menu/Levels + the now-enabled Airport cards section), all button descriptions, inline button icons, Escape/backdrop/close-button dismissal, Chinese translations |
