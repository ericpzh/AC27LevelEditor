...
```bash
npm run test:all      # Full suite: Vitest (1279) + save integrity (21) + jetway rebuild (16) + runway pairs (5) + E2E (17, ~5 min)
npm test              # Vitest component + store + utility + electron + integration + MapWindow + updater tests (1279 tests, 61 files, ~11s)
...
## Layer 1 — Vitest Component Tests (1335 tests, 66 files)
...
### `npm test` — 1335 pass (66 test files; includes the Ground Painter scenery suite)
