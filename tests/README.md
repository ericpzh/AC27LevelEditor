...
```bash
npm run test:all      # Full suite: Vitest (2181) + save integrity (27) + jetway rebuild (27) + runway pairs (5) + E2E (18, ~8 min)
npm test              # Vitest component + store + utility + electron + integration + MapWindow + updater tests (2181 tests, 116 files, ~35s)
