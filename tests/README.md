...
```bash
npm run test:all      # Full suite: Vitest (1741) + save integrity (27) + jetway rebuild (27) + runway pairs (5) + E2E (18, ~8 min)
npm test              # Vitest component + store + utility + electron + integration + MapWindow + updater tests (1741 tests, 100 files, ~24s)
...
## Layer 1 — Vitest Component Tests (1741 tests, 100 files)
...
### `npm test` — 1741 pass (100 test files; includes the Ground Painter scenery suite + airway roundtrip + the full Livery page suite)
...
| **Livery page (custom liveries):** | **225** | |
