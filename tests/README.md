...
```bash
npm run test:all      # Full suite: Vitest (2170) + save integrity (27) + jetway rebuild (27) + runway pairs (5) + E2E (18, ~8 min)
npm test              # Vitest component + store + utility + electron + integration + MapWindow + updater tests (2170 tests, 115 files, ~45s)
...
## Layer 1 — Vitest Component Tests (2170 tests, 115 files)
