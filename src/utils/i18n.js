const STR = {
  zh: {
    ...
    modal_custom_type_body:'自定义呼号无法在游戏中播放无线电语音。',
    ...
    tutorial_custom_type_p1:'使用 {{btn:customType}} 按钮可自由输入航司代码和航班号。自定义呼号无法在游戏中播放无线电语音。',
  ...
  en: {
    ...
    toolbar_custom_type:'Custom Callsign',
    toolbar_help:'Help',
    ...
    tutorial_custom_type_p1:'Use the {{btn:customType}} button to freely type in Airline and Flight # in this mode. Note that custom callsigns will not play correct radio audio in-game.',
