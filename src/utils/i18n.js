const STR = {
  zh: {
    ...
    air_map_bg:'地图',
    air_map_airspace:'空域', air_map_runway_ext:'延长线', air_map_labels:'STAR/SID',
    ground_map_taxiway:'滑行道',
    ground_map_show_all:'显示全部',
    map_refresh:'刷新',
    knob_zoom:'缩放', knob_pan_h:'E-W', knob_pan_v:'S-N',
  ...
  en: {
    ...
    air_map_bg:'Map',
    air_map_airspace:'Airspace', air_map_runway_ext:'Runway Ext.', air_map_labels:'STAR/SID',
    ground_map_taxiway:'Taxiway',
    ground_map_show_all:'Display All',
    map_refresh:'Refresh',
    knob_zoom:'Zoom', knob_pan_h:'E-W', knob_pan_v:'S-N',
