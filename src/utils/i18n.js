const STR = {
  zh: {
    ...
    val_stand_conflict:'{{cs1}} 和 {{cs2}}: 停机位 "{{stand}}" 时段冲突 ({{cs1}}: {{t1_start}}-{{t1_end}}, {{cs2}}: {{t2_start}}-{{t2_end}})',
  ...
  en: {
    ...
    val_stand_conflict:'{{cs1}} and {{cs2}}: stand "{{stand}}" has overlapping occupancy ({{cs1}}: {{t1_start}}-{{t1_end}}, {{cs2}}: {{t2_start}}-{{t2_end}})',
