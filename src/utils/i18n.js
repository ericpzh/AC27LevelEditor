const STR = {
  zh: {
    ...
    modal_custom_type_title:'自定义呼号模式',
    modal_custom_type_body:'自定义呼号将无法在游戏中播放正确的无线电语音。',
    modal_custom_type_checkbox:'不再显示',
    ...
    tutorial_heading_custom_type:'自定义呼号模式',
    tutorial_custom_type_p1:'底部工具栏的「自定义呼号」按钮允许你输入游戏中不存在的航司代码和航班号：',
    tutorial_custom_type_li1:'点击按钮开启模式后，航司代码和航班号列将变为文本输入框（不再是下拉菜单）',
    tutorial_custom_type_li2:'机型下拉列表将显示全部可用机型（不再按航司筛选），注册号按机型筛选',
    tutorial_custom_type_li3:'自定义呼号在游戏中不会播放正确的无线电语音，编辑器会在首次开启时提醒',
  ...
  en: {
    ...
    modal_custom_type_title:'Custom Callsign Mode',
    modal_custom_type_body:'Custom callsign will not have proper radio call in-game.',
    modal_custom_type_checkbox:"Don't show again",
    ...
    toolbar_custom_type:'Custom Type',
    toolbar_help:'Help',
    ...
    tutorial_heading_custom_type:'Custom Callsign Mode',
    tutorial_custom_type_p1:'The "Custom Type" button in the bottom toolbar lets you enter airline codes and flight numbers that don\'t exist in the game:',
    tutorial_custom_type_li1:'Click the button to enable the mode — Airline and Flight # columns become text inputs instead of dropdowns',
    tutorial_custom_type_li2:'The Aircraft dropdown shows all available types (no longer filtered by airline); Registration is filtered by aircraft type only',
    tutorial_custom_type_li3:'Custom callsigns will not play correct radio audio in-game — the editor will warn you the first time you enable this mode',
